...
class StoryReportPage extends Component {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    ...
    if (currentUser) {
      ...
      const response = await Parse.Cloud.run("previewStory", {
        storyId: storyId
      });
            ...
            <>
              ...
              {storyItem.type === type.STORY_ITEM.greyArea ? (
                <div className="small-12 grid-x">
                  ...
                  <div className="medium-10 small-12">
                    <div className="content-section padding-top gray-text">
                      <p style="background-color: #e2dede; padding: 10px">
                        {storyItem.contents.text}
                      </p>
                    </div>
                  </div>
              ...
              {storyItem.type === type.STORY_ITEM.list ? (
                <div class="small-12 grid-x">
                  <div class="medium-1 hide-for-small" />
                  <div class="medium-10 small-12">
                    <div class="content-section padding-top gray-text">
                      <ul>
            ...
            <div className="grid-container grid-x align-middle">
              ...
              <div className="small-10 grid-x">
                <div className="grid-x text-center align-center">
                  ...
                  <span>
                    <button
                      style={{ color: "#cb574c", fontWeight: 700 }}
                      type="button"
                      id="btnCancel"
                      className="cancel"
