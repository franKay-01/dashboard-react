...
class StoryChangeSticker extends Component {
  constructor(props) {
    super(props);
  ...
  handleSelection = async event => {
    ...
    if (currentUser) {
      if (items !== "") {
        ...
        const response = await Parse.Cloud.run("changeStickerItem", {
    ...
    return (
      <>
        ...
        <div className="medium-8 large-8 topList">
          <b>Changing Sticker for StoryItem</b>
        </div>
...
export default StoryChangeSticker;
